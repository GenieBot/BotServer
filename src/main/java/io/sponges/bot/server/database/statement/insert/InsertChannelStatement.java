...
public class InsertChannelStatement extends AbstractStatement<Boolean> {

    private final UUID uuid;
    private final String sourceId;
    private final UUID networkId;

    public InsertChannelStatement(Database database, UUID uuid, String sourceId, UUID networkId) {
        super(database, Statements.INSERT_CHANNEL);
        this.uuid = uuid;
