...
public class GoogleCommand extends Command {
    ...
    public void onCommand(CommandRequest request, String[] args) {
        ...
        try {
            Document doc = Jsoup.connect(url).followRedirects(true).header("User-Agent", "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2227.0 Safari/537.36 SpongyBot/1.0").header("X-Request-By-Username", request.getUser().getId()).get();
